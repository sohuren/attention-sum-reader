...
class RUSSReader(TextComprehensionBase):
	...
	# theano.config.compute_test_value = 'warn'
        ...
        memory_encoded_btf2.name = "memory_encoded_btf2"
	gater = self.create_bidi_encoder("gater", 2*hidden_states, hidden_states)
	memory_encoded_btf3 = gater.apply(memory_encoded_btf2.dimshuffle(1,0,2), context_mask_bt)

        mem_attention_presoft_bt = tt.batched_dot(query_representation_bf, memory_encoded_btf3.dimshuffle(0,2,1))
